...
export default function InstagramTab() {
  ...
  return (
    <div className="space-y-5">
      ...
      {!loading && !error && result && (
        <>
              ...
              <div className="flex items-start justify-between">
                <div>
                  <div className="flex items-center gap-2">
                    <h2 className="text-lg font-bold" style={{ color: "#292524" }}>{result.profile.fullName || result.profile.username}</h2>
                ...
                <div className="flex gap-2">
                  <button type="button" onClick={() => toggleSave(result.profile.username)} className="p-2 rounded-lg" style={{ color: savedAccounts.includes(result.profile.username) ? "#F59E0B" : "#C4AA8A" }}>
          ...
          {result.posts.length > 0 && (
            <div className="rounded-xl p-5" style={cardStyle}>
              <div className="flex items-center gap-2 mb-4"><Image className="w-4 h-4" style={{ color: IG }} /><h3 className="font-semibold" style={{ color: "#292524" }}>Recent Posts ({result.posts.length})</h3></div>
      ...
      {!searched && (
        <div className="rounded-xl p-5" style={cardStyle}>
          <div className="flex items-center gap-2 mb-4"><TrendingUp className="w-4 h-4" style={{ color: IG }} /><h3 className="font-semibold" style={{ color: "#292524" }}>Popular Accounts</h3></div>
          <div className="flex flex-wrap gap-2">
            {POPULAR_ACCOUNTS.map(acc => (
              <button key={acc} type="button" onClick={() => { setUsername(acc); searchUser(acc); }}
                ...
                style={{ background: `linear-gradient(135deg, ${IG}10, ${IG2}10)`, color: "#292524", border: `1px solid ${IG}20` }}
      ...
      {history.length > 0 && (
        <div className="rounded-xl p-5" style={cardStyle}>
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2"><Clock className="w-4 h-4" style={{ color: "#F59E0B" }} /><h3 className="font-semibold" style={{ color: "#292524" }}>Recent Searches</h3></div>
      ...
      {savedAccounts.length > 0 && (
        <div className="rounded-xl p-5" style={cardStyle}>
          <div className="flex items-center gap-2 mb-3"><Bookmark className="w-4 h-4" style={{ color: "#F59E0B" }} /><h3 className="font-semibold" style={{ color: "#292524" }}>Saved Accounts ({savedAccounts.length})</h3></div>
          <div className="flex flex-wrap gap-2">
