...
const FEATURES: Feature[] = [
  ...
  { id: "a05", name: "Premium AI Actions — Monthly Counter", category: "AI", status: "done", priority: "critical", description: "RPC atomic consume_premium_action. Cote: free=5, lite=20, pro=50, business=200, enterprise=1000", addedAt: "2026-04" },
  { id: "a06", name: "Per-plan AI Model Routing", category: "AI", status: "done", priority: "high", description: "Free/Lite → Haiku 4.5, Pro/Business/Enterprise → Sonnet 4.6", addedAt: "2026-04" },
