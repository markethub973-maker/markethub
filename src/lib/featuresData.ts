...
export interface FeatureCatalogEntry {
  ...
  // Demo system: prefer "workflow" (CSS-animated explainer) for
  // software features. When a real product video is ready (via the
  // Nano Banana 2 + Kling 3.0 pipeline), set demo_kind: "video"
  // and demo_src: "/demos/<slug>.mp4" — the video takes priority.
  demo_kind: "screenshot" | "video" | "spline" | "workflow";
  demo_src?: string;             // path to image / mp4 / spline iframe URL
