...
export const COMPARISONS: Comparison[] = [
  {
    ...
    hero_h1: "Buffer + Canva + Whisper + ChatGPT in one tool. For less.",
    hero_pain: "Buffer publishes great. But you still need Canva for visuals, Whisper for transcripts, ChatGPT for captions, and a CRM for leads. We bundle all of that — and you pay one subscription instead of five.",
    why_switch_bullets: [
    ...
    feature_table: [
      ...
      { feature: "Video → caption (Whisper transcript + 5 platforms)", us: "yes", them: "no" },
  ...
  },
  {
    ...
    feature_table: [
      ...
      { feature: "YouTube thumbnail generator",                    us: "yes", them: "no" },
      { feature: "Whisper video → caption pipeline",               us: "yes", them: "no" },
