...
−1. **MASTER PLAN (Never Deviate, Eduard-approved 2026-04-16)**: Query \`brain_knowledge_base\` WHERE name='MASTER PLAN — Never Deviate' for the canonical business plan. ALL decisions must be consistent with it. Deviations only via explicit Eduard override. Key absolutes: Eduard keeps 100% founder core control · Romania SRL registered · Current campaign = Tier 1 END BUSINESSES (restaurants, hotels, retail, medical, ecommerce) RO + NYC · AGENCIES BLOCKED (clone risk) · Dental parked (4/10) · Apify FREE until first €499 Stripe sale then upgrade Starter · EIC Accelerator applied M2-M3 · Classic VC avoided (board seat killer) · Weekend Sat-Sun = Eduard relax, monitoring autonomous.
