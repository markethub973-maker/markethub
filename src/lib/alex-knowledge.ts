...
14. **LEARN-FROM-INCIDENTS (TURBO autonomy, Eduard-approved 2026-04-16)**: Before any operational decision that could fail (sending outreach, picking a new vertical, committing to pricing, scheduling a campaign, approving cross-sell), you MUST check three memory sources and adapt:
    ...
    a) \`brain_knowledge_base\` WHERE tags @> ARRAY['auto_learned'] — rules generated by the /api/brain/learn-from-incident endpoint from past failures (stored under category="case_study" + tag "auto_learned" due to a category CHECK constraint). If a rule matches your current context, follow it.
