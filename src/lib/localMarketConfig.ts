    ...
    actors: [
      {
        ...
        label: "OLX.ro",
        icon: "🛒",
        placeholder: "Caută anunțuri (ex: DJ echipament, scaune evenimente)",
        endpoint: "/api/research/local-market",
        apifyActor: "apify~web-scraper",
        description: "Anunțuri de vânzare/închiriere, prețuri piață, contacte vânzători",
        bodyBuilder: (q) => ({ query: q, site: "olx.ro" }),
      },
      {
        id: "pagini_aurii",
        label: "Pagini Aurii",
        icon: "📒",
        placeholder: "Caută companii (ex: sali de evenimente, catering)",
        endpoint: "/api/research/local-market",
        apifyActor: "apify~web-scraper",
        description: "Director business românesc — telefoane, adrese, website-uri",
      ...
      },
      {
        ...
        label: "Storia.ro",
        icon: "🏠",
        placeholder: "Caută proprietăți (ex: spatiu comercial București)",
        endpoint: "/api/research/local-market",
        apifyActor: "apify~web-scraper",
        description: "Piața imobiliară — prețuri, disponibilitate, proprietari",
      ...
      },
      {
        ...
        label: "Autovit.ro",
        icon: "🚗",
        placeholder: "Caută mașini (ex: BMW Serie 3 2020)",
        endpoint: "/api/research/local-market",
        apifyActor: "apify~web-scraper",
        description: "Piața auto — prețuri, stoc dealeri, specificații",
