...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (username === "admin" && password === "markethub2024") {
    ...
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "#FFF8F0" }}>
      <div className="w-full max-w-md px-6">
        ...
        >
          ...
          <div className="mt-6 p-3 rounded-lg text-xs" style={{ backgroundColor: "rgba(245,215,160,0.15)", border: "1px solid rgba(245,215,160,0.3)" }}>
            <p className="font-semibold mb-1" style={{ color: "#78614E" }}>Credentiale demo:</p>
            <p style={{ color: "#A8967E" }}>Username: <b style={{ color: "#5C4A35" }}>admin</b></p>
            <p style={{ color: "#A8967E" }}>Parola: <b style={{ color: "#5C4A35" }}>markethub2024</b></p>
          </div>
        </div>

        <p className="text-center text-xs mt-6" style={{ color: "#C4AA8A" }}>
          © 2026 MarketHub Pro · <a href="/privacy" style={{ color: "#F59E0B" }}>Privacy</a> · <a href="/terms" style={{ color: "#F59E0B" }}>Terms</a>
        </p>
      </div>
    </div>
  );
