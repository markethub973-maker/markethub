        ...
        {(Object.keys(FEATURE_CATEGORIES) as Array<keyof typeof FEATURE_CATEGORIES>).map((cat) => {
          ...
          return (
            <section key={cat} className="space-y-4">
              <div>
                <h2 className="text-2xl font-bold" style={{ color: "var(--color-text)" }}>{meta.label}</h2>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {items.map((f) => (
                  ...
                  >
                    ...
                    <p className="text-sm font-bold mb-1" style={{ color: "var(--color-text)" }}>{f.title}</p>
                    <p className="text-xs mb-3" style={{ color: "#78614E", lineHeight: 1.5 }}>{f.tagline}</p>
                    <p className="text-[11px] font-bold inline-flex items-center gap-1" style={{ color: "var(--color-primary-hover)" }}>
