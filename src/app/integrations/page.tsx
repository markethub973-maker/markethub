  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        ...
        version: "stripe ^17.7",
        logo: "💳",
        purpose: "Subscription checkout (Starter $9 / Lite $19 / Pro $39 / Business $99 / Enterprise $249), token recharge packs, webhooks (checkout, cancellation, payment failed)",
        envVars: [
          { key: "STRIPE_SECRET_KEY", desc: "Backend secret key" },
          { key: "STRIPE_WEBHOOK_SECRET", desc: "Webhook signature verification" },
          { key: "STRIPE_STARTER_PRICE_ID", desc: "Price ID — $9/mo" },
          { key: "STRIPE_LITE_PRICE_ID", desc: "Price ID — $19/mo" },
          { key: "STRIPE_PRO_PRICE_ID", desc: "Price ID — $39/mo" },
...
const ENV_SUMMARY = [
  ...
  { group: "Stripe", vars: ["STRIPE_SECRET_KEY", "STRIPE_WEBHOOK_SECRET", "STRIPE_STARTER_PRICE_ID", "STRIPE_LITE_PRICE_ID", "STRIPE_PRO_PRICE_ID", "STRIPE_BUSINESS_PRICE_ID", "STRIPE_ENTERPRISE_PRICE_ID"] },
