      ...
      <main className="max-w-5xl mx-auto px-6 py-6 space-y-5">
        ...
        >
          <div className="flex items-center gap-2">
            <UserSearch className="w-5 h-5" style={{ color: "#F59E0B" }} />
          ...
          <section className="space-y-3">
            {leadName && (
              <p className="text-xs font-semibold" style={{ color: "#78614E" }}>
                Enrichment for <span style={{ color: "#292524" }}>{leadName}</span>
              </p>
            )}
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm font-bold flex-1" style={{ color: "#292524" }}>Company angle</p>
                <button
                  type="button"
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm font-bold flex-1" style={{ color: "#292524" }}>Ideal pitch</p>
                <button
                  type="button"
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <p className="text-sm font-bold flex-1" style={{ color: "#292524" }}>Opener message (send as-is)</p>
                <button
                  type="button"
                  onClick={() => copy("opener", result.opener_message)}
                  className="inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-bold"
                  style={{ backgroundColor: copied === "opener" ? "#10B981" : "#D97706", color: "white" }}
                >
              ...
              >
                ...
                <ul className="list-disc pl-5 space-y-1">
                  {result.red_flags.map((f, i) => (
                    <li key={i} className="text-sm" style={{ color: "#292524", lineHeight: 1.5 }}>
                      {f}
                    </li>
                  ))}
                </ul>
