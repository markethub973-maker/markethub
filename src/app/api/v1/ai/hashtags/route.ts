/**
 * POST /api/v1/ai/hashtags — Bearer-token hashtag suggester.
 * Platform-aware counts and tone. Pro+.
 */
...
const PLATFORM_GUIDANCE: Record<string, string> = {
  instagram: "Instagram: 10-20 hashtags optimal. Mix popular (>1M) with niche (<100K).",
  linkedin:  "LinkedIn: 3-5 hashtags ONLY. Professional, industry-specific. No emojis.",
  tiktok:    "TikTok: 5-10 hashtags. Mix 2-3 trending + niche-specific. #fyp and #foryou ok.",
  facebook:  "Facebook: 3-5 hashtags. Focus on relevance, not trending.",
  twitter:   "Twitter/X: 1-3 hashtags max. Use sparingly.",
  youtube:   "YouTube: 3-5 tags in description. Specific + searchable over trending.",
};
...
- Match the caption's language.${voicePrompt}`;
