...
export async function GET() {
  ...
  const params = new URLSearchParams({
    ...
    scope: "instagram_basic,instagram_business_content_publish,instagram_manage_insights,pages_show_list,pages_read_engagement,instagram_manage_comments,instagram_business_manage_messages,ads_read,business_management",
    response_type: "code",
