...
export default function ShopPage() {
  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ backgroundColor: "var(--color-bg-secondary)" }}>
        <ShoppingBag className="w-10 h-10 mb-3" style={{ color: "#A8967E" }} />
        <p className="text-base font-bold" style={{ color: "var(--color-text)" }}>Product not found</p>
        ...
        <Link href="/" className="text-xs font-bold mt-4 underline" style={{ color: "var(--color-primary-hover)" }}>← Back home</Link>
      </div>
    );
  }
    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--color-bg-secondary)" }}>
      ...
      <main className="max-w-5xl mx-auto px-6 py-10 space-y-12">
        ...
        {product.description && (
          <section className="max-w-3xl">
            {product.description.split(/\n\s*\n/).map((para, i) => (
              <p key={i} className="text-base mb-3" style={{ color: "var(--color-text)", lineHeight: 1.7 }}>
                {para}
              </p>
            ))}
          </section>
        ...
        {product.steps.length > 0 && (
          <section>
            <h2 className="text-2xl font-bold mb-5" style={{ color: "var(--color-text)" }}>How to use it</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {product.steps.map((s, i) => (
                ...
                >
                  ...
                  <p className="text-sm font-bold mb-2 mt-1" style={{ color: "var(--color-text)" }}>{s.heading}</p>
