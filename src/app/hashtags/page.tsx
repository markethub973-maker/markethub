...
export default function HashtagsPage() {
  ...
  return (
    <div>
      <Header title="Hashtag Tracker" subtitle="Explore any Instagram hashtag — top posts and trends" />
          ...
          <div className="space-y-5">
            ...
            {posts?.length > 0 ? (
              ...
              <div className="rounded-xl p-8 text-center" style={cardStyle}>
                <p className="text-sm" style={{ color: "#A8967E" }}>No posts available for this hashtag.</p>
              </div>
            )}
          </div>
        )}
